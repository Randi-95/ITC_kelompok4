    ...
    <div class="profile max-w-[80%] mx-auto py-14">
        ...
        <div class="border-b border-blue-500/20 mb-6">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center">
                ...
                <li class="mr-2">
                    <a href="riwayat.php" class="inline-block p-4 border-b-2 border-transparent text-white hover:text-blue-300 hover:border-blue-300/30 rounded-t-lg">History</a>
                </li>
            </ul>
        </div>
